   ...
   public class HIDUSBDevice : IDisposable
   {
      ...
      internal bool WriteData(byte[] data)
      {
         ...
         if (IsConnected)
         {
            ...
            Array.ConstrainedCopy(data, 0, outputReportBuffer, 1, data.Length);
      ...
      internal class OutputReport : HostReport
      {
         ...
         protected override bool ProtectedWrite(IntPtr hidHandle, byte[] outputReportBuffer)
         {
            ...
            try
            {
               ...
               hResult = Core.WriteFile(hidHandle, outputReportBuffer, (uint) outputReportBuffer.Length, out uNumberOfBytesWritten, IntPtr.Zero);
