...
namespace UavTalk
{
	public class GPSVelocity : UAVDataObject
	{
		public const long OBJID = 2185616512;
		public int NUMBYTES { get; set; }
		protected const String NAME = "GPSVelocity";
		...
		public GPSVelocity() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
