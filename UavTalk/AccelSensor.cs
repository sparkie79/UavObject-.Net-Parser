...
namespace UavTalk
{
	public class AccelSensor : UAVDataObject
	{
		public const long OBJID = 2340143030;
		public int NUMBYTES { get; set; }
		protected const String NAME = "AccelSensor";
		...
		public AccelSensor() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
