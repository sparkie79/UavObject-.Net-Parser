...
namespace UavTalk
{
	...
	{
		public const long OBJID = 3182803918;
		public int NUMBYTES { get; set; }
		protected const String NAME = "HwCopterControl";
		...
		public HwCopterControl() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
		...
		public void setDefaultFieldValues()
		{
			...
			MPU6000Rate.setValue(MPU6000RateUavEnum.v500);
		...
		public override UAVDataObject clone(long instID) {
			...
			try {
				HwCopterControl obj = new HwCopterControl();
		 ...
		 */
		public HwCopterControl GetInstance(UAVObjectManager objMngr, long instID)
		{
			return (HwCopterControl)(objMngr.getObject(HwCopterControl.OBJID, instID));
		}
	}
}
