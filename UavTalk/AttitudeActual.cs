...
namespace UavTalk
{
	public class AttitudeActual : UAVDataObject
	{
		public const long OBJID = 869979622;
		public int NUMBYTES { get; set; }
		protected const String NAME = "AttitudeActual";
		...
		public AttitudeActual() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
