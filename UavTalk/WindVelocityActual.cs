...
namespace UavTalk
{
	...
	{
		public const long OBJID = 1831981816;
		public int NUMBYTES { get; set; }
		protected const String NAME = "WindVelocityActual";
	    protected static String DESCRIPTION = @"Stores 3D wind speed estimation.";
		...
		public WindVelocityActual() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
		...
		public override UAVDataObject clone(long instID) {
			...
			try {
				WindVelocityActual obj = new WindVelocityActual();
		 ...
		 */
		public WindVelocityActual GetInstance(UAVObjectManager objMngr, long instID)
		{
			return (WindVelocityActual)(objMngr.getObject(WindVelocityActual.OBJID, instID));
		}
	}
}
