...
namespace UavTalk
{
	public class GyroState : UAVDataObject
	{
		public const long OBJID = 2351792394;
		public int NUMBYTES { get; set; }
		protected const String NAME = "GyroState";
		...
		public GyroState() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
