...
namespace UavTalk
{
	public class PositionActual : UAVDataObject
	{
		public const long OBJID = 4204670274;
		public int NUMBYTES { get; set; }
		protected const String NAME = "PositionActual";
		...
		public PositionActual() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
