...
namespace UavTalk
{
	public class VelocityActual : UAVDataObject
	{
		public const long OBJID = 1510536730;
		public int NUMBYTES { get; set; }
		protected const String NAME = "VelocityActual";
		...
		public VelocityActual() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
