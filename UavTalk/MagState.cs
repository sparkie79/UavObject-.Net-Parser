...
namespace UavTalk
{
	public class MagState : UAVDataObject
	{
		public const long OBJID = 2986585672;
		public int NUMBYTES { get; set; }
		protected const String NAME = "MagState";
		...
		public MagState() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
