...
namespace UavTalk
{
	public class BaroAltitude : UAVDataObject
	{
		public const long OBJID = 2573348458;
		public int NUMBYTES { get; set; }
		protected const String NAME = "BaroAltitude";
		...
		public BaroAltitude() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
