...
namespace UavTalk
{
	public class VelocityDesired : UAVDataObject
	{
		public const long OBJID = 2660526482;
		public int NUMBYTES { get; set; }
		protected const String NAME = "VelocityDesired";
		...
		public VelocityDesired() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
