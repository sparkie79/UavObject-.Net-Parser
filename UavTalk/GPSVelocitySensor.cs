...
namespace UavTalk
{
	public class GPSVelocitySensor : UAVDataObject
	{
		public const long OBJID = 197489748;
		public int NUMBYTES { get; set; }
		protected const String NAME = "GPSVelocitySensor";
		...
		public GPSVelocitySensor() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
