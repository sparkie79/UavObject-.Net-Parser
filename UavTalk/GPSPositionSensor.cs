...
namespace UavTalk
{
	public class GPSPositionSensor : UAVDataObject
	{
		public const long OBJID = 441927886;
		public int NUMBYTES { get; set; }
		protected const String NAME = "GPSPositionSensor";
		...
		public GPSPositionSensor() : base (OBJID, ISSINGLEINST, ISSETTINGS, NAME)
		{
